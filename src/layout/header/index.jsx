...
const Header = ({ data, ...other }) => {
	...
	return (
		<HeaderStyles
			...
			px={smallScreen ? "1.15rem" : mediumScreen ? "3rem" : 0}
			// sx={{
			// 	flexShrink: 0,
		...
		>
			...
			>
				...
				<Box
					...
					sx={{
						height: !!mediumScreen ? "2.1rem" : "2.65rem",
			...
			>
				...
				<SocialLinks socialLinks={personalInformation?.socialLinks} pt={6} />
				{!mediumScreen && (
					<>
						<Box
							flexGrow={1}
